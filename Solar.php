...
<body>
    ...
    <p>
        ...
        <br>
        Die Strahlungsenergie, die die Erde von der Sonne innerhalb von 90 Minuten empfängt, entspricht etwa dem
        Weltenergieverbrauch eines ganzen Jahres. So erwärmt die Sonne unsere Atmosphäre, Ozeane und Landmassen, sorgt
        für
        Pflanzenwachstum sowie Wind und Wetter. Einen kleinen Bruchteil dieser Energie können wir durch bereits heute
        verfügbare
        Technologien erschließen und zur Strom- und Wärmebereitstellung nutzen.
        <br>
        Der Anteil der Sonnenenergie an der deutschen Energieversorgung steigt kontinuierlich. Ausschlaggebend dafür
        sind
        private Haushalte, auf denen die meisten Solaranlagen betrieben werden. In der Regel ist die Installation auf
        oder an
        Gebäuden genehmigungsfrei – mit der Ausnahme von denkmalgeschützten Gebäuden. Lediglich Solarparks sind
        genehmigungspflichtig und erfordert einen entsprechenden Bebauungsplan.
    </p>
    ...
    <p>
        ...
        Solarzelle
        ist ein Halbleiter, meist Silizium. Das Sonnenlicht wird in Gleichstrom umgewandelt, der direkt zum Betrieb
        elektrischer
